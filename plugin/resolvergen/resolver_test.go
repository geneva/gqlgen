...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/geneva/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func TestOmitTemplateComment(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/geneva/gqlgen/plugin/resolvergen/testdata/omit_template_comment/out")
}
...
func testFollowSchemaPersistence(t *testing.T, dir string) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/geneva/gqlgen/plugin/resolvergen/"+dir+"/out")
}
